...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--eval-conf-thre", type=float, default=None, help="Confidence threshold for validation decode")
    parser.add_argument("--vis-conf-thre", type=float, default=None, help="Confidence threshold for visualization decode")
    parser.add_argument("--mixup-prob", type=float, default=None, help="Mixup probability")
    parser.add_argument("--mixup-alpha", type=float, default=None, help="Mixup beta distribution alpha")
    parser.add_argument("--cls-label-smoothing", type=float, default=None, help="Classification label smoothing")
